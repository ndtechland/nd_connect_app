...
LeaveDropdownModels leaveDropdownModelsFromJson(String str) => LeaveDropdownModels.fromJson(json.decode(str));

String leaveDropdownModelsToJson(LeaveDropdownModels data) => json.encode(data.toJson());
...
class LeaveDropdownModels {
  ...
  factory LeaveDropdownModels.fromJson(Map<String, dynamic> json) => LeaveDropdownModels(
    succeeded: json["succeeded"],
    statusCode: json["statusCode"],
    status: json["status"],
    message: json["message"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    getLeaveList: json["getLeaveList"] == null ? [] : List<GetLeaveList>.from(json["getLeaveList"]!.map((x) => GetLeaveList.fromJson(x))),
    getLeaveTypeList: json["getLeaveTypeList"] == null ? [] : List<GetLeaveTypeList>.from(json["getLeaveTypeList"]!.map((x) => GetLeaveTypeList.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "getLeaveList": getLeaveList == null ? [] : List<dynamic>.from(getLeaveList!.map((x) => x.toJson())),
    "getLeaveTypeList": getLeaveTypeList == null ? [] : List<dynamic>.from(getLeaveTypeList!.map((x) => x.toJson())),
  };
}
...
class GetLeaveTypeList {
  ...
  factory GetLeaveTypeList.fromJson(Map<String, dynamic> json) => GetLeaveTypeList(
    id: json["id"],
    leavetype: json["leavetype"],
    leaveValue: json["leaveValue"]?.toDouble(),
    isactive: json["isactive"],
