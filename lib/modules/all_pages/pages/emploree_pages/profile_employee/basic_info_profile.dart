...
class BasicEmployeeProfile extends StatelessWidget {
  final ProfileEmployeeController _getprofileebasic =
      Get.put(ProfileEmployeeController());

  // static const String id = 'Profile';

  BasicEmployeeProfile({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(
        () => (_getprofileebasic.isLoading.value)
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    "${_getprofileebasic.getbasicemployeeModel?.data?.fullName.toString()}",
                                    style: TextStyle(
                                        fontSize: 12,
                                        fontFamily: 'medium',
                                        color: Colors.black),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    "${_getprofileebasic.getbasicemployeeModel?.data?.workEmail.toString()}",
                                    style: TextStyle(
                                        fontSize: 12,
                                        fontFamily: 'medium',
                                        color: Colors.black),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    "${_getprofileebasic.getbasicemployeeModel?.data?.dateOfJoining.toString()}",
                                    style: TextStyle(
                                        fontSize: 12,
                                        fontFamily: 'medium',
                                        color: Colors.black),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    "${_getprofileebasic.getbasicemployeeModel?.data?.jobTitle.toString()}",
                                    style: TextStyle(
                                        fontSize: 12,
                                        fontFamily: 'medium',
                                        color: Colors.black),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    "${_getprofileebasic.getbasicemployeeModel?.data?.companyname.toString()}",
                                    style: TextStyle(
                                        fontSize: 12,
                                        fontFamily: 'medium',
                                        color: Colors.black),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    "${_getprofileebasic.getbasicemployeeModel?.data?.ofccityname}",
                                    style: TextStyle(
                                        fontSize: 12,
                                        fontFamily: 'medium',
                                        color: Colors.black),
